<%-- 
    ...
    Created on : 8 may. 2024, 1:14:27 p. m.
...
<head>
    ...
    <title>Log in - Puro Sabor Peruano</title>
        ...
        <div class="container">
            <div class="row mb-4">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <p class="fw-bold text-dark mb-2">Inicio de Sesión</p>
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-md-5 col-lg-5 d-flex align-items-center p-5 justify-content-center">
