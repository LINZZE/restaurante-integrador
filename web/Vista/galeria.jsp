<%-- 
    Document   : galeria
    Created on : 8 may. 2024, 1:14:13 p. m.
...
<body>
        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center d-inline-block" href="/"><img src="../assets/img/restaurantlogo.png" width="50"><span id="menu" class="mx-1" style="font-family: Artifika, serif;">Puro Sabor Peruano</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="galeria.jsp" style="font-family: Artifika, serif;">Galería</a></li>
    ...
    <section id="contenido" class="py-5" style="background: #f5f6f8;">
        <section class="photo-gallery py-4 py-xl-5">
            <div class="container">
                <div class="row mb-5">
                    <div class="col-md-8 col-xl-6 text-center mx-auto text-dark" style="font-family: Artifika, serif;">
                        <h2>Galería de imágenes</h2>
                    </div>
                </div>
                <div class="row gx-2 gy-2 row-cols-1 row-cols-md-2 row-cols-xl-3 photos" data-bss-baguettebox="">
                    <div class="col item"><a href="https://cdn.bootstrapstudio.io/placeholders/1400x800.png"><img class="img-fluid" alt="Person Holding Pastry Dishes on White Ceramic Plates" src="../assets/img/pexels-photo-262978.jpeg"></a></div>
                    <div class="col item"><a href="https://cdn.bootstrapstudio.io/placeholders/1400x800.png"><img class="img-fluid" alt="Chef Preparing Vegetable Dish on Tree Slab" src="../assets/img/pexels-photo-1267320.jpeg"></a></div>
                    <div class="col item"><a href="https://cdn.bootstrapstudio.io/placeholders/1400x800.png"><img class="img-fluid" alt="White and Brown Cooked Dish on White Ceramic Bowls" src="../assets/img/pexels-photo-958545.jpeg"></a></div>
                    <div class="col item"><a href="https://cdn.bootstrapstudio.io/placeholders/1400x800.png"><img class="img-fluid" alt="Person Making Dough" src="../assets/img/pexels-photo-784633.jpeg"></a></div>
                    <div class="col item"><a href="https://cdn.bootstrapstudio.io/placeholders/1400x800.png"><img class="img-fluid" alt="Person Making Dough" src="../assets/img/pexels-photo-784633.jpeg"></a></div>
                    <div class="col item"><a href="https://cdn.bootstrapstudio.io/placeholders/1400x800.png"><img class="img-fluid" alt="Close-up Photo of Dinnerware Set on Top of Table With Glass Cups" src="../assets/img/pexels-photo-1395967.jpeg"></a></div>
                    <div class="col item"><a href="https://cdn.bootstrapstudio.io/placeholders/1400x800.png"><img class="img-fluid" alt="Restaurant Table and Chairs" src="../assets/img/pexels-photo-914388.jpeg"></a></div>
                    <div class="col item"><a href="https://cdn.bootstrapstudio.io/placeholders/1400x800.png"><img class="img-fluid" alt="Restaurant Table and Chairs" src="../assets/img/pexels-photo-914388.jpeg"></a></div>
                    <div class="col item"><a href="https://cdn.bootstrapstudio.io/placeholders/1400x800.png"><img class="img-fluid" alt="Restaurant Table and Chairs" src="../assets/img/pexels-photo-914388.jpeg"></a></div>
                </div>
            </div>
